...
export const settingsApi = {
  ...
  async restoreCodexUnifiedHistory(): Promise<CodexUnifyHistoryRestoreResult> {
    return invoke("restore_codex_unified_history");
  },

  async cleanCodexDatabase(): Promise<number> {
    return invoke("clean_codex_database");
  },
  ...
  async setCopilotOptimizerConfig(config: CopilotOptimizerConfig): Promise<boolean> {
